            ...
            success: function (msg) {
                ...
                $.each(msg, function (key) {
                    ...
                    $('.result').replaceWith('<div class="col-xs-12 result">' +
                        ...
                        '<tr><th>ID</th><th>Priority</th><th>Path</th>' +
                        '<th>Showed</th><th>Method</th><th>Created</th></tr><tr>' +
                        result + '</tr></table></div>');
                });
                setTimeout(load_requests, 2000);
            }
        });
    };
    load_requests();
